...
## 📌 Based on  
Made in Webflow:  
[Lazy Load Videos](https://webflow.com/made-in-webflow/website/lazy-load-videos-f99d06?ref=made-in-webflow-search&searchValue=lazy%20load%20video){target="_blank"}  
and  
[Vanilla LazyLoad](https://github.com/verlok/vanilla-lazyload){target="_blank"}  
...
## Lottie File
[Lottie Icon for download](https://cdn.prod.website-files.com/68edd383533e3a5e345de43d/6902de7c439e25e4b9a224ab_1240.json){target="_blank"}  
```html
